...
public class DelhiMetroMap {
    ...
    // CREATE MAP
    public static void Create_Metro_Map(DelhiMetroMap g) {
        // ADDING VERTICES
    ...
    public static void main(String[] args) throws IOException {
        DelhiMetroMap g = new DelhiMetroMap(); // Object of metro
        ...
        while (true) {
            ...
            switch (choice) {
                ...
                case 4 -> {
                    ...
                    if (!g.containsStations(strr1) || !g.containsStations(strr2)
                            || !g.hasPath(strr1, strr2, processed1))
                        System.out.println("THE INPUTS ARE INVALID");
                    else {
